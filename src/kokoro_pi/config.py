...
SERVE: tuple[Option, ...] = (
    ...
    Option("wyoming", "bool", False,
           "also serve the Wyoming protocol, which is how Home Assistant talks to a voice service"),
    Option("wyoming_port", "int", 10200, "port for the Wyoming listener"),
